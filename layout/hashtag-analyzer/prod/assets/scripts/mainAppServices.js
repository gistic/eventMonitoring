...
angular.module('trackHashtagApp.services').factory('KeywordEmailsFactory', ['$http', function ($http) {
	var fn = {};
...
angular.module('trackHashtagApp.services').factory('KeywordPeriodFactory', ['$http', function ($http) {
	var fn = {};
