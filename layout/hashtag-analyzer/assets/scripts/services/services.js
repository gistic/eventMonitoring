...
.factory('User', ['$rootScope', '$cookies', '$cookieStore', 'RequestData', '$location', function ($rootScope, $cookies, $cookieStore, RequestData, $location) {
